...
if __name__ == "__main__":
    postgres_extractor = SQLExtractor(
        connection_config={
            "db_type": "postgresql",
            "host": "pg-1fb8b489-sourav-e030.g.aivencloud.com",  # no postgres:// here
            "port": 12510,
            "database": "defaultdb",
            "username": "avnadmin",
            "password": "AVNS_-3hJmvkmJGQao0_rlbn",
        }
    )
    ...
    df, metadata = postgres_extractor.extract(
        query="""
            SELECT
                s.student_id,
